...
import com.bezkoder.springjwt.models.MyUserPrinciple;
...
//	標註此方法需要有token的驗證才可以使用
	...
	public String userAccess(Principal principal, Authentication authentication1, @AuthenticationPrincipal UserDetailsImpl myUserPrinciple) {
		...
		System.out.println("myUserPrinciple:"+ myUserPrinciple.toString());
